package com.myzr.allproducts.entity;
...
public class StyleResEntity {
    ...
    public static String FILENAME_ROATION_REV_MID_GIF = "roation_rev_mid_normal";
    public static String FILENAME_ROATION_REV_LOW_GIF = "roation_rev_low_normal";
