 ...
 */
public class UserNickNameViewModel extends BaseViewModel<DemoRepository> {
    //用户名的绑定
    ...
    //封装一个界面发生改变的观察者
    public UserNickNameViewModel.UIChangeObservable uc = new UserNickNameViewModel.UIChangeObservable();
    ...
    public UserNickNameViewModel(@NonNull Application application, DemoRepository repository) {
